...
public static class Pair{
    ...
    static ArrayList <Integer> verticalOrder(Node root)
    {
         ArrayList<Integer>ans = new ArrayList<>();
           int min1 =0;
           int max1 =0;
        //mapping of horizontal distance with  list of nodes
        ...
        while(q.size()>0){
            ...
            int hd = p.second;
            min1 =Math.min(min1,hd);
            max1 =Math.max(max1,hd);
            //add in map
            map.putIfAbsent(hd ,new ArrayList<>());
                map.get(hd).add(root.data);
             
            //left subtree
            if(root.left!=null)q.add(new Pair(root.left,hd-1));
            //right subtree
            if(root.right!=null)q.add(new Pair(root.right,hd+1));            
        }
