...
//             profit =Math.max(prices[index]+maxi( index+2 ,prices ,1 , n) ,0+maxi( index+1 ,prices ,0,n));
...
//             profit =Math.max(prices[index]+maxi( index+2 ,prices ,1 , n,dp) ,0+maxi( index+1 ,prices ,0,n,dp));
